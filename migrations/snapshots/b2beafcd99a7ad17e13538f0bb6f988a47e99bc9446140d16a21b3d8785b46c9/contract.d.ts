...
export type StorageHash =
  StorageHashBase<'b2beafcd99a7ad17e13538f0bb6f988a47e99bc9446140d16a21b3d8785b46c9'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly WorkspaceEmail: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly email: CodecTypes['pg/text@1']['output'];
      readonly forwardTo: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly WorkspaceEmail: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly email: CodecTypes['pg/text@1']['input'];
      readonly forwardTo: CodecTypes['pg/text@1']['input'];
...
export namespace Models {
  ...
  export type public_WorkspaceEmail = {
    id: CodecTypes['pg/int4@1']['output'];
    email: CodecTypes['pg/text@1']['output'];
    forwardTo: CodecTypes['pg/text@1']['output'];
...
export declare const models: {
  public: {
    ...
    WorkspaceEmail: Models.public_WorkspaceEmail;
  };
};
      ...
      readonly public: {
        readonly models: {
          ...
          readonly WorkspaceEmail: {
            ...
            readonly storage: {
              readonly table: 'workspaceEmail';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly email: { readonly column: 'email' };
                readonly forwardTo: { readonly column: 'forwardTo' };
